...
dependencies {
    ...
    compileOnly("net.kyori:adventure-api:${project.parent?.property("kyori.adventure.version")}")
    compileOnly("net.kyori:adventure-text-minimessage:${project.parent?.property("kyori.adventure.version")}")
